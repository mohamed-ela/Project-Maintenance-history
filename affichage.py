...
class Application:
    def __init__(self, master):
        ...
        # heading
        self.heading = Label(master, text="REGISTRE DES ARRETS", font=('arial 60 bold'), fg='green')
        self.heading.place(x=350, y=0)

        # button to change bookings
        self.change = Button(master, text="ARRET SUIVANT", width=25, height=2, bg='steelblue', command=self.func)
